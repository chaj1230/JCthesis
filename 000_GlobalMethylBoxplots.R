...
# this is .txt file I made from Bismark data with headings: "sampleID,	treatment (VEHICLE, CORT, CONTROL, CRS),methylCpG (% global methylation)"
...
# boxplot all 4 groups -- THIS IS FIGURE 7 IN THESIS
