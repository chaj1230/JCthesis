# later make a function for these steps
# run it for CORT vs VEHICLE, CRS vs CTRL, CRS vs CORT
...
cort.list_no.rr5=list("~/Desktop/THESIS/covs/G695_rr01_S15_val_1_bismark_bt2_pe.bismark.cov",
               "~/Desktop/THESIS/covs/G695_rr02_S16_val_1_bismark_bt2_pe.bismark.cov",
               "~/Desktop/THESIS/covs/G695_rr03_S17_val_1_bismark_bt2_pe.bismark.cov",
               "~/Desktop/THESIS/covs/G695_rr04_S18_val_1_bismark_bt2_pe.bismark.cov",
               "~/Desktop/THESIS/covs/G695_rr06_S20_val_1_bismark_bt2_pe.bismark.cov",
...
cort_no.rr5=methRead(cort.list_no.rr5,
              sample.id = list("rr01", "rr02", "rr03", "rr04", "rr06", "rr07", "rr08", "rr09", "rr10"),
...
getCoverageStats(cort[[3]],plot=TRUE,both.strands=FALSE)
...
cort.filter_no.rr5=filterByCoverage(cort_no.rr5,lo.count=10,lo.perc=NULL,
                               hi.count=NULL,hi.perc=99.9)

getMethylationStats(cort.filtered[[5]],plot=TRUE,both.strands=FALSE)

getCoverageStats(cort.filtered[[3]],plot=TRUE,both.strands=FALSE)
...
cort_unite_no.rr5=unite(cort_no.rr5, destrand=FALSE)
cort.filtered_unite_no.rr5=unite(cort.filter_no.rr5, destrand=FALSE)
...
clusterSamples(cort.filtered_unite_no.rr5, dist="correlation", method="ward", plot=TRUE)

clusterSamples(cort_unite_no.rr5, dist="correlation", method="ward", plot=TRUE)
