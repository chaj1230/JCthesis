...
bedtools intersect -wa -a $file3 -b ../H3K27ac-ENCFF792TCD.bed > bedintersect_output/H3K27ac_$file3
...
bedtools intersect -wa -a $file3 -b ../H3K4me3-ENCFF953HUV.bed > bedintersect_output/H3K4me3_$file3
bedtools intersect -wa -a $file3 -b ../H3K4me1-ENCFF801KBC.bed > bedintersect_output/H3K4me1_$file3
...
bedtools intersect -wa -a $file3 -b ../CTCF-ENCFF715PXI.bed > bedintersect_output/ctcf_$file3
